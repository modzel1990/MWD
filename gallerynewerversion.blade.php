    ...
    <div class="page-wrapper" id="page-top">
        ...
        <header id="hero">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
                ...
                <div class="imgcont">
                  <img class="size" src="/img/house6.jpg" alt="house">
                </div>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav ml-auto">
                        ...
                        <a class="nav-item nav-link" href="#news">Blog</a>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="text-align-right push-down">
                                    <h2 data-scroll-reveal="enter left and move 10px">High Quality, Modern HMO's</h2>
                                ...
                                <div class="box box--pricing" data-scroll-reveal="enter bottom and move 10px">
                                    <div class="box__wrapper">
                                        ...
                                        <div class="box__footer">
                                              <a href="#contact" class="btn btn-primary">Arrange a viewing</a>
                                        </div>
                                    </div>
                                    <!--end box__wrapper-->
                                </div>
                               ...
                               <div class="col-md-12">
                                 ...
                                 <div class="col-md-4 pad">
                                  ...
                                  <h3 class="modalush3">Description of Property</h3>
                                   ...
                                   <p class="modalusp"><i class="fas fa-money-bill-alt"></i> Price: <span class="price">170 000</span></p>
                                  ...
                                  <div class="desccont center">
                                    ...
                                    <div class="contact disp" onclick="formchoice(1)">Contact <span class="price">Now</span></div>
                             ...
                             <div class="modal-contentus">
                               ...
                               <div class="col-md-12">
                                 ...
                                 <div class="desccont center">
                                   ...
                                   <div class="contact disp" onclick="formchoice(2)">Contact <span class="price">Now</span></div>
                             ...
                             <div class="modal-contentus">
                               ...
                               <div class="col-md-12">
                                 ...
                                 <div class="desccont center">
                                   ...
                                   <div class="contact disp" onclick="formchoice(3)">Contact <span class="price">Now</span></div>
